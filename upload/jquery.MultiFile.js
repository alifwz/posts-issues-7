	...
	$.fn.MultiFile = function (options) {
		...
		this
			...
			.each(function () {
				...
				MultiFile.E.wrap('<div class="MultiFile-wrap" id="' + MultiFile.wrapID + '"></div>');//Raj
				MultiFile.wrapper = $('#' + MultiFile.wrapID + '');//Raj
				...
				if (!MultiFile.list) {
					...
					$(this).parents('.uploader').find('.fileContainer').append('<div class="MultiFile-list" id="' + MultiFile.wrapID + '_list"></div>');//Raj
