	...
	if (($ext1 == "mp4") || ($ext1 == "mov")) {	
		if($size<(3145728000))
		{
			...
			{				
				...
				$imgquery = mysql_query("INSERT INTO freelancer_mmv_userimages (id, userid, image, type, countryid, website, date, freelanceserviceid, status) VALUES ('', '".$loginid."','".$new_flv."','2','$pcountry','$videolink',NOW(),'$freelanceserviceid','$status')");
