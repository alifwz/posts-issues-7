...
$invtypequery = mysql_query("SELECT * FROM freelancer_mmv_member_invitation WHERE invitation_id='$id'");
$invtyperes = mysql_fetch_array($invtypequery);
$invt = $invtyperes[invitationtype];

if($invt==1){
	$desc = "Meet";
	$price  = $count*$typeres[hire];
} else if($invt==2){
	$desc = "invite";
	$price  = $count*$typeres[invite];
}
	...
	<section class="contenets-main">
		...
		<div class="container">
			<div class="row form-main text-align-center">
				<div class="col-12"><h2>Please pay for Inviting/Meeting</h2></div>				
				<div class="col-12">			  
				...
				<div class="col-12">
					...
					<div class="col-12">
						...
						<input type="hidden" name="custom" value="<?php echo $loginid.'@'.$id; ?>">
						<!-- Specify URLs --> 
						<input type='hidden' name='cancel_return' value='<?php echo $urlpath ?>checkout_fail.php'>
						<input type='hidden' name='return' value='<?php echo $urlpath ?>inv_complete.php'>
