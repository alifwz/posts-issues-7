...
<div class="type-message-main">
	...
	<form name="myForm" id="myForm" action="chatsubmit.php?id=<?php echo $id ?>" method="post">
	<input type="hidden" name="timezone" value="<?php echo $timezone ?>">
	<input type="hidden" name="invid" value="<?php echo $inv; ?>">
		<button type="submit" name="submit" onclick="return check_val();" class="send-btn"><img src="images/send-btn.png" alt="send"/></button>
