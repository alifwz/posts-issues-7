                        ...
                        <?php if ($loginid == "") { ?>
                            ...
                            <div class="col-4 uploader"><a
                                <?php if ($notcomplete == 1) { ?>
                                    ...
                                    <?php } ?>>Post a photo</a><div class="fileContainer"></div>				
                            ...
                            <div class="col-4"><a <?php if ($notcomplete == 1) { ?>
                                        data-fancybox data-type="inline" data-src="#profilefillPopup" href="javascript:void(0);"
                                    <?php } else {
                                        ?> href="post-a-job.php" <?php } ?>class="post-a-job">Post a job</a></div>
                            <div class="col-4 uploader"><a <?php if ($notcomplete == 1) { ?>
                                        data-fancybox data-type="inline" data-src="#profilefillPopup" href="javascript:void(0);"
                                    <?php } else {
                                        ?> href="javascript:void(0);" data-options='{"closeClickOutside":false,"touch": false}' data-fancybox data-type="inline" data-src="#videoPopup" <?php } ?>>Post a Video</a><div class="fileContainer"></div>
                                <!--<a href="javascript:void(0);" data-fancybox data-type="inline" data-src="#videoPopup">Post a Video</a>
                                <input name="videoimg" accept=".mp4" type="file" id="post-video-upload" required class="multi with-preview"/>-->
                            </div>
