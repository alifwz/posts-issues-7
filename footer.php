...
<style>
                        ...
                        <ul>
                            ...
                            if ($loginid != "") {
                                if ($login_result['first_name'] == '' || $login_result['last_name'] == '' || $login_result['country'] == '' || $login_result['nationality'] == '' || $login_result['expsectornew'] == '' || $login_result['hobby'] == '' || $login_result['mbti'] == '' || $login_result['area'] == '') {
                                    ...
                                    <li><a data-fancybox data-type="inline" data-src="#profilefillPopup" href="javascript:void(0);"><span class="menu-icon"><img src="images/icon-feedback.png" alt="Feedback / Report" /></span> Feedback / Report</a></li>
                                    <?php if ($res[verifiedstatus] == 0) { ?>
                                        <li><a data-fancybox data-type="inline" data-src="#profilefillPopup" href="javascript:void(0);"><span class="menu-icon"><img src="images/icon-verified.png" alt="Verified User" /></span> Verified User</a></li>
                                        <?php
                                    }
                                } else {
                                    ?>
                            ...
                            <li>
                                ...
                                <?php } else { ?>
                                    <a id="login_btn" data-fancybox data-type="inline" data-options='{"closeClickOutside":false,"touch":false}' data-src="#loginPopup" href="javascript:;"><span class="menu-icon"><img src="images/icon-logout.png" alt="Logout" /></span> Login</a>
                                <?php } ?>					
                            </li>
                        </ul>
                    </div>
            ...
            <form name="upload" id="imageform" action='ajaximage.php' method="post" enctype="multipart/form-data">
                <div class="photo-job-video">
                    ...
                    <div class="row" style="margin-bottom: 0px;">
                        <?php if ($loginid == "") { ?>
                            <div class="col-3 uploader"><a data-fancybox data-type="inline" data-src="#loginPopup" href="javascript:void(0);" class="border_post">photo</a></div>
                            <div class="col-2"><a data-fancybox data-type="inline" data-src="#loginPopup" href="javascript:void(0);" class="border_post">job</a></div>
                            <div class="col-3 uploader"><a href="javascript:void(0);" data-fancybox data-type="inline" data-src="#loginPopup" class="border_post">Video</a></div>
                            <div class="col-4 uploader"><a href="javascript:void(0);" data-fancybox data-type="inline" data-src="#loginPopup">Question</a></div>
                            <?php
                        } else {
                            $notcomplete = 0;
                            if ($login_result['first_name'] == '' || $login_result['last_name'] == '' || $login_result['country'] == '' || $login_result['nationality'] == '' || $login_result['expsectornew'] == '' || $login_result['hobby'] == '' || $login_result['mbti'] == '' || $login_result['area'] == '') {
                            ...
                            <div class="col-2"><a <?php if ($notcomplete == 1) { ?>
                                        data-fancybox data-type="inline" data-src="#profilefillPopup" href="javascript:void(0);"
                                    <?php } else {
                                        ?> href="post-a-job.php" <?php } ?> class="border_post">job</a></div>
                            <div class="col-3 uploader"><a <?php if ($notcomplete == 1) { ?>
                                        data-fancybox data-type="inline" data-src="#profilefillPopup" href="javascript:void(0);"
                                    <?php } else {
    ...
    <div class="popbox">
        ...
        <div id="profilefillPopup" class="popupbox text-align-center">

            <div class="login-main">
                <form>
                    <p style="color:red">Please complete your profile details to access all features</p>
                        <div class="form-group">
                            <div class="row login-register">
                                ...
                                <a style="background: #b8cc8d;" href="make-profile.php" class="button loginbtn">Okay</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="popbox">
   ...
   <p style="color:#00b159; font-weight:bold;">Deleted Successfully</p>		
    </div>
</div>
