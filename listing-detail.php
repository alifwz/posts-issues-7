                    ...
                    if ($memid != $loginid) {
                        ...
                        if ($login_result['first_name'] == '' || $login_result['last_name'] == '' || $login_result['country'] == '' || $login_result['nationality'] == '' || $login_result['expsectornew'] == '' || $login_result['hobby'] == '' || $login_result['mbti'] == '' || $login_result['area'] == '') {
                            ...
                            <div class="threebtns">
                                <div class="row intrested-edit-cancel">
                                    <div class="col-4 intrested-div">
                                        <a style="color: black" data-fancybox data-type="inline" data-src="#profilefillPopup"  class="button">Interested</a>
                                    </div>
                                    <div class="col-4 edit-div">
                                        <a style="color: black" data-fancybox data-type="inline" data-src="#profilefillPopup"  class="button light-yellow">Interested if</a>
                                    </div>	
                            ...
                            <div class="threebtns">
                                <div class="row intrested-edit-cancel">
                                    <div class="col-4 intrested-div">
                                        <a style="color: black" href="submitfavourites.php?id=<?php echo $memid; ?>&workid=<?php echo $workid ?>" class="button">Interested</a>
                                    </div>
                                    <div class="col-4 edit-div">
                                        <a style="color: black" href="javascript:void(0);" class="button light-yellow editHourDayBtn">Interested if</a>
                                    </div>	
                                    <div class="col-4 cancel-div">
                                        <a href="listing.php" class="button light-pink">Cancel</a>
                                    </div>
